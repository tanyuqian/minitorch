...
def test_pow_1_teacher(sizes, exp, backend):
...
@pytest.mark.parametrize("backend", backend_tests)
def test_pow_2_teacher(sizes, exp, backend):
...
@pytest.mark.parametrize("backend", backend_tests)
def test_pow_3_teacher(sizes, exp, backend):
...
@pytest.mark.parametrize("sizes", [(5,), (128,), (1, 64), (128, 256)])
@pytest.mark.parametrize("backend", backend_tests)
def test_tanh_1_teacher(sizes, backend):
...
@pytest.mark.parametrize("sizes", [(5,), (128,), (1, 64), (128, 256)])
@pytest.mark.parametrize("backend", backend_tests)
def test_tanh_2_teacher(sizes, backend):
