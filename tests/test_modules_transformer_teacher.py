...
def test_multihead_attention_teacher(batch_size, queries_len, n_embd, num_heads, p_dropout, backend):
...
@pytest.mark.parametrize("backend", _BACKENDS, ids=["CudaKernelOps"])
def test_feedforward_layer_teacher(batch_size, seq_len, n_embd, dropout, backend):
...
@pytest.mark.parametrize("backend", _BACKENDS, ids=["CudaKernelOps"])
def test_transformer_layer_1_teacher(batch_size, seq_len, n_embd, num_heads, p_dropout, ln_eps, bias, backend):
...
@pytest.mark.parametrize("bias", [False])
@pytest.mark.parametrize("backend", _BACKENDS, ids=["CudaKernelOps"])
def test_transformer_layer_2_teacher(batch_size, seq_len, n_embd, num_heads, p_dropout, ln_eps, bias, backend):
...
@pytest.mark.parametrize("backend", _BACKENDS, ids=["CudaKernelOps"])
def test_decoder_lm_teacher(batch_size, seq_len, n_vocab, n_embd, n_head, n_positions, dropout, ln_eps, bias, backend):
